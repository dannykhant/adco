...
class Deepseekv4Flashmysqlv2Driver(AbstractDriver):
    DEFAULT_CONFIG = {
    ...
    def __init__(self, ddl):
        ...
        if os.path.exists(mysql_ddl):
            ddl = mysql_ddl
        super(Deepseekv4Flashmysqlv2Driver, self).__init__("deepseekv4flashmysqlv2", ddl)
        self.host = None
        self.port = None
        self.user = None
        self.password = None
    ...
    def makeDefaultConfig(self):
        return Deepseekv4Flashmysqlv2Driver.DEFAULT_CONFIG

    def loadConfig(self, config):
        for key in Deepseekv4Flashmysqlv2Driver.DEFAULT_CONFIG:
